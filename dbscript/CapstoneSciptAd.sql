create database HappyBakery
	...
	create table IngredientUsed (
		UsedId int identity(1,1) primary key,
	...
	create table UserDelivery (
		DeliverID int identity(1,1) primary key,
	...
	insert into Users values ('Tap Hoa Nguyen Quoc Manh', 'manh@gmail.com', 'manhse', '0987654321', '2021-02-21', 'Binh Dinh', 'Male', 'STORE', 1, '', '')
	...
	-- 5 newest display store
	insert into Recipe values ('3', 'Crepe', 'So Delicious', '2022-02-21', '', '30', '40', '3', 'img/crepe.jpg', '1', '1', '1')
	insert into Recipe values ('3', 'Waffle', 'Pretty Good', '2022-08-08', '', '60', '50', '4', 'img/waffe.jpg', '1', '2', '1')

	insert into Step values ('Prepared the ingredients', '1', '1')
	insert into Step values ('Mix those up', '1', '1')
	insert into Step values ('Cook in the total time', '1', '1')

	insert into CommentRecipe values ('1', '4', 'Not bad at all, all my friends love it!', '5', '', 1)
	insert into CommentRecipe values ('2', '5', 'The ingredients is not healthy in my opinion', '1', '', 1)
	insert into CommentRecipe values ('1', '4', 'Not bad at all, all my friends love it!', '4', '', 1)	
	insert into CommentRecipe values ('1', '5', 'The ingredients is not healthy in my opinion', '3', '', 1)
	insert into CommentRecipe values ('1', '4', 'Not bad at all, all my friends love it!', '2', '', 1)
	insert into CommentRecipe values ('1', '5', 'The ingredients is not healthy in my opinion', '0', '', 1)
	...
	insert into StoreAvailabe values ('Sugar', '2', '1', '200', '', '200', '1', '5', '1', '', '1')
	insert into StoreAvailabe values ('Egg','2', '2', '100', '', '100', '1', '10', '2', '', '1')
	insert into StoreAvailabe values ('Baking Soda', '2', '3', '50', '', '300', '1', '2', '1', '', '1')

	insert into Orders values ('2021-02-21', '', '1', '3')
	insert into Orders values ('2021-02-21', '', '1', '4')
	insert into Orders values ('2021-02-21', '', '1', '5')

	insert into OrderDetail values ('1', '1', '10', '17000')
	insert into OrderDetail values ('2', '1', '20', '17000')
	insert into OrderDetail values ('3', '1', '30', '17000')

	insert into BlogCategory values ('Experience')
	insert into BlogCategory values ('Knowledge')

	-- 5 newest display store
	insert into Blog values ('3', 'img/thermomix.png', '2021-02-21', 'Best Cooking Machine', 'It makes cooking easier than ever before', '', 'Its an flour mixer!', 1, 1)
	insert into Blog values ('4', 'img/thermomix.png', '2021-02-21', 'Making You In Love With Cooking', 'A great machine, help you to cook anything', '', 'Its an oven', 1, 1)
	insert into Blog values ('3', 'img/thermomix.png', '2021-02-21', 'Drying Machine', 'Dry Food everywhere!', '', 'Its an flour mixer!', 1, 1)
	insert into Blog values ('4', 'img/thermomix.png', '2021-02-21', 'Temperature Calculator', 'Perfect steak, why not?', '', 'Its an oven', 2, 1)
	insert into Blog values ('3', 'img/thermomix.png', '2021-02-21', 'Ultimate Cooker', 'Delicious meal everyday', '', 'Its an flour mixer!', 2, 1)

	insert into IngredientUsed values ('1', '1')
	insert into IngredientUsed values ('2', '1')
	insert into IngredientUsed values ('3', '1')

	insert into CommentRecipe values ('1', '6', 'Not bad at all, all my friends love it!', '5', '', 1)
	insert into CommentRecipe values ('1', '7', 'The statements is false', '1', '', 1)
	insert into CommentRecipe values ('1', '8', 'It really helpful for me', '4', '', 1)	
	insert into CommentRecipe values ('1', '9', 'Pretty good but there are still something not right', '3', '', 1)
	insert into CommentRecipe values ('1', '10', 'Ridiculous!', '2', '', 1)
