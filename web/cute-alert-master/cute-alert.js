...
const cuteAlert = ({
  ...
  return new Promise(resolve => {
    ...
    if (type === 'error-q') {
      btnTemplate = `
      <div class="error-q-buttons">
        <button class="confirm-button ${type}-bg ${type}-btn">${confirmText}</button>
        <button class="cancel-button error-qq-btn">${cancelText}</button>
      </div>
      `;
    }
    ...
    if (type === 'question' || type == 'success-q' || type == 'error-q') {
