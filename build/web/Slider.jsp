        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                ...
                <div class="text">
                    ...
                    <a class="slider-redirect" href="Recipe.jsp">EXPLORE NOW</a>
                </div>
            </div>
            ...
            <div class="mySlides fade">
                ...
                <div class="text">
                    ...
                    <a class="slider-redirect" href="Blog.jsp">EXPLORE NOW</a>
                </div>
            </div>
            ...
            <div class="mySlides fade">
                ...
                <div class="text">
                    ...
                    <a class="slider-redirect" href="Store.jsp">EXPLORE NOW</a>
                </div>
            </div>
