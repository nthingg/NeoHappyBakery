<%-- 
    ...
    Created on : Oct 28, 2022, 1:50:00 PM
    Author     : ADMIN
--%>
    ...
    <body>
        <c:set var="user" value="${sessionScope.user}"></c:set>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="MainController?action=manageAccount" class="dropdown-item nav-item nav-link active">Block/UnBlock</a>
                            </div>
                            <div class="nav-item dropdown">
            ...
            <div class="content">
                ...
                <div id="myBtnContainerAdmin" class="filter-selection-admin">
                    <button class="btn-admin active-filter-admin"
                            onclick="filterSelectionAdmin('user-table')">User Table</button>
                    <button class="btn-admin " onclick="filterSelectionAdmin('store-table')">Store Table</button>
                </div>

                <div class="filterDivAdmin user-table container-fluid pt-4 px-4 padd-top-0">
                    <div class="row g-4 bg-cl-grey mgn-0">
                                ...
                                <div class="bg-secondary rounded h-100 p-4">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach var="acc" items="${sessionScope.listUserManager}">
                                                    <tr>
                                                        <th scope="col"><c:out value="${acc.getUserId() }"></c:out></th>
                                                        <th scope="col"><c:out value="${acc.getUserName()}"></c:out></th>
                                                        <th scope="col"><c:out value="${acc.getUserMail()}"></c:out></th>
                                                        <th scope="col"><c:out value="${acc.getUserPhone()}"></c:out></th>
                                                            <th scope="col">
                                                            <c:choose >
                                                                <c:when test="${acc.getUserStatus() eq 1}">Active</c:when>
                                                                <c:otherwise >Inactive</c:otherwise>
                                                            </c:choose>
                                                        </th>
                                                        <th scope="col"><c:url var="mylink" value="MainController">
                                                                <c:param name="email" value="${acc.getUserMail()}"></c:param>
                                                                <c:param name="status" value="${acc.getUserStatus()}"></c:param>
                                                                <c:param name="action" value="changeUserStatus"></c:param>
                                                            </c:url>
                                                            <c:choose>
                                                                <c:when test="${acc.getUserStatus() == 1 }"><a href="${mylink}" >Block</a></c:when>
                                                                <c:otherwise><a href="${mylink}" >UnBlock</a></c:otherwise>
                                                            </c:choose>
                                                        </th>
                                                    </tr>
                                                </c:forEach>
                ...
                <div class="filterDivAdmin store-table container-fluid pt-4 px-4 padd-top-0">
                    <div class="row g-4 bg-cl-grey mgn-0">
                        <div class="col-sm-12 col-xl-12">
                            <div class="col-12">
                                <div class="bg-secondary rounded h-100 p-4">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach var="acc" items="${sessionScope.listStoreManager}">
                                                    <tr>
                                                        <th scope="col"><c:out value="${acc.getUserId() }"></c:out></th>
                                                        <th scope="col"><c:out value="${acc.getUserName()}"></c:out></th>
                                                        <th scope="col"><c:out value="${acc.getUserMail()}"></c:out></th>
        ...
        <script src="js/filterAdminProfile.js"></script>
    </body>
</html>
