<%-- 
    ...
    Created on : Oct 28, 2022, 1:50:14 PM
    Author     : ADMIN
--%>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-transparent border-0">
                                    <a href="MainController?action=manageBlog" class="<%= (request.getParameter("typeBlog").equals("view"))? "dropdown-item nav-link active" : "dropdown-item" %>">View all</a>
                                    <a href="MainController?action=getReportedBlog" class="<%= (request.getParameter("typeBlog").equals("reported"))? "dropdown-item nav-link active" : "dropdown-item" %>">Reported</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                            ...
                            <div class="bg-secondary rounded h-100 p-4">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <%
                                            if("view".equals(request.getParameter("typeBlog"))){
                                            %>
                                            <c:forEach var="blog" items="${sessionScope.ListBlog}">
                                                <tr>
                                            ...
                                            <%
                                                }else if("reported".equals(request.getParameter("typeBlog"))){
%>
                                            <c:forEach var="blog" items="${sessionScope.ListReportedBlog}">
                                                <tr>
                                                    <th scope="col"><c:out value="${blog.getBlogId() }"></c:out></th>
                                                    <th scope="col"><c:out value="${blog.getUserId()}"></c:out></th>
                                                    <th scope="col"><c:out value="${blog.getBlogTitle()}"></c:out></th>
                                                    ...
                                                    <th scope="col"><c:url var="mylink" value="MainController">
                                                        ...
                                                        <a href="${mylink}">View Detail</a></th>    
                                                    <th><c:url var="mylink" value="MainController">
                                                            <c:param name="BlogID" value="${blog.getBlogId()}"></c:param>
