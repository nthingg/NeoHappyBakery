...
public class manageBlogServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("BlogManagement.jsp?typeBlog=view").forward(request, response);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(manageBlogServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
