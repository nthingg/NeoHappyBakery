...
public class SpecIngredientDAO {
    ...
    public static ArrayList<SpecIngredient> getIngredientsById(int userId) throws Exception {
        ...
        if (cn != null) {
            //Step 2: viết sql 
            String sql = "select SpecificAvailID, sa1.IngredientID as 'IngredientID', IngredientName, sa1.StoreID as 'StoreID', sa1.Quantity as 'Quantity', sa1.IngredientImg as 'Image', sa1.Price as 'Price', \n"
                    ...
                    + "where sa1.StoreID = ? and sa1.AvailStatus = 1";
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    SpecIngredient specIngredient = new SpecIngredient(SpecificAvailID, IngredientID, IngredientName, userId, Quantity, Image, Price, SalePercent, CategoryName, AddedDay);
