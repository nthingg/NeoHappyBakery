    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (actiontype.equalsIgnoreCase("create")) {
                ArrayList<BlogCate> listBlogCategory = new ArrayList<>();
                try {
                    listBlogCategory = BlogDAO.getAllBlogCates();
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
                session.setAttribute("listBlogCategory", listBlogCategory);
                response.sendRedirect("BlogCreate.jsp");
                ...
                session.setAttribute("blogUpdateBlog", blog);
                response.sendRedirect("BlogUpdate.jsp");
            }
        }
    }
