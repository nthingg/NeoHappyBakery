 ...
 * @author thinh
 */
public class FilterRecipe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (textSearch.isEmpty()) {
                try {
                    recipeList = RecipeDAO.getRecipeByUserId(storeId);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            } else {
                try {
                    recipeList = RecipeDAO.filterRecipe(storeId, textSearch, searchby);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
