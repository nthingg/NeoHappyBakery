...
public class UpdateRecipe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String yields = request.getParameter("yields");
            ...
            try {
                RecipeDAO.updateRecipe(recipeId, preptime, cooktime, yields, description, listStepCv);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
            int addedId = recipeId;
            String imgName = "recipeUpdate" + addedId;
